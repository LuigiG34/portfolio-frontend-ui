            ...
            <div className="col-xl-3 col-lg-5 col-md-6 mb-50">
              <div className="tp-footer-2-widget footer-col-2-3">
                ...
                <div className="tp-footer-2-contact-item">
                  <span>
                    <Link
                      to="https://www.google.com/maps/@23.8223596,90.3656686,15z?entry=ttu"
                      target="_blank"
                    >
                ...
                <div className="tp-footer-2-contact-item">
                  <span>
                    <Link to="tel:+725214456">P: + 725 214 456</Link>
                  </span>
                </div>
                <div className="tp-footer-2-contact-item">
                  <span>
                    <Link to="mailto:contact@liko.com">E: contact@liko.com</Link>
                  </span>
                </div>
              </div>
            </div>
