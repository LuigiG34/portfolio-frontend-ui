...
import BlogDetailsAreaTwo from "../../component/blog/details/blog-details-area-2";
                                        ...
                                        <div className="col-xl-12">
                                            <div className="blog-details-thumb">
                                                <img
                                                    className="w-100"
                                                    data-speed=".8"
                                                    src="/assets/img/inner-blog/blog-details-without-sidebar/blog-details-3.jpg"
                                                    alt="blog_bg"
                                                    style={{ height: "auto" }}
                                                />
                                            </div>
