...
import { Close, Minus, Plus } from "../../component/svg";
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="tp-cart-title">
                                                            <Link to="/shop-details/1">Legendary Whitetails Women.</Link>
                                                        </td>
                                                        ...
                                                        <td className="tp-cart-add-to-cart">
                                                            <button type="submit" className="tp-btn-cart sm">Add To Cart</button>
                                                        </td>
                                            ...
                                            <div className="row align-items-end">
                                                <div className="col-xl-6">
                                                    <div className="tp-cart-update">
                                                        <Link to="/cart" className="tp-btn-cart">Go To Cart</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
