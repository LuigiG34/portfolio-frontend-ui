...
import ContactLocationTwo from "../../component/contact/contact-location-2";
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-xl-10">
                                            <div
                                                ...
                                                style={{ backgroundImage: "url(/assets/img/inner-contact/contact/contact-bg.png)" }}
                                            >
                                                <div className="cn-contactform-support-text text-center">
                                                    <span>Or, you can contact one of our studios directly below. We aim to respond within 24 hours.</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
