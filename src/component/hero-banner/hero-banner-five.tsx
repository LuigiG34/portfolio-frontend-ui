      ...
      <div className="container-fluid">
        <div className="col-xl-12">
          <div className="tp-hero-5-content-box">
            ...
            <Link className="tp-btn-black-square" to="/portfolio-grid-col-2">
              View Our Works
              <span>
                <UpArrow />
              </span>
            ...
            <div className="tp-project-5-thumb-wrap d-flex align-items-center">
              <div className="tp-project-5-thumb">
                <Link to="/portfolio-details-1">
                  <img src="/assets/img/home-05/project/project-2.jpg" alt="project-img" />
                </Link>
              </div>
              <div className="tp-project-5-thumb">
              ...
              <div className="tp-project-5-thumb">
                <Link to="/portfolio-details-1">
                  <img src="/assets/img/home-05/project/project-3.jpg" alt="project-img" />
                </Link>
              </div>
            </div>
          </div>
