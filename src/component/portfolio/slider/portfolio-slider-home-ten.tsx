...
const slider_thumbs = [
  {
    id: 1,
    img: "/assets/img/home-11/port-sm-1.jpg",
    subtitle: "Digital Design",
    year: "2024",
  ...
  {
    id: 2,
    img: "/assets/img/home-11/port-sm-2.jpg",
    subtitle: "Digital Design",
    year: "2022",
  ...
  {
    id: 3,
    img: "/assets/img/home-11/port-sm-3.jpg",
    subtitle: "Digital Design",
    year: "2021",
  ...
  {
    id: 4,
    img: "/assets/img/home-11/port-sm-4.jpg",
    subtitle: "Digital Design",
    year: "2021",
  ...
  {
    id: 5,
    img: "/assets/img/home-11/port-sm-5.jpg",
    subtitle: "Digital Design",
    year: "2021",
    title: "Zon Robinson",
  },
              ...
              >
                <div className="tp-portfolio-11-slider-content">
                  <div className="tp-portfolio-11-slider-link">
                    <Link to="/portfolio-details-video">
                      <DownArrow />
                    </Link>
                  </div>
                  ...
                  <div className="tp-portfolio-11-slider-nav-content d-flex flex-column justify-content-between">
                    ...
                    <div className="tp-portfolio-11-slider-nav-tittle-box">
                      ...
                      <h4 className="tp-portfolio-11-slider-nav-tittle">
                        <Link to="/portfolio-details-video">{item.title}</Link>
                      </h4>
                    </div>
                  </div>
                </div>
