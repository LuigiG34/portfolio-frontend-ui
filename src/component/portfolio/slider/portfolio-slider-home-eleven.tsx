...
// slider images
const slider_images = [
  "/assets/img/inner-project/showcase/showcase-1.jpg",
  "/assets/img/inner-project/showcase/showcase-2.jpg",
  "/assets/img/inner-project/showcase/showcase-3.jpg",
  "/assets/img/inner-project/showcase/showcase-4.jpg",
];
        ...
        >
          ...
          >
            ...
            <div className="port-showcase-slider-social tp-hover-btn-wrapper d-none d-md-block">
              <Link className="tp-hover-btn-item" to="#">Fb</Link>
              <Link className="tp-hover-btn-item" to="#">In</Link>
              <Link className="tp-hover-btn-item" to="#">Be</Link>
            </div>
          </div>
        </div>
      </div>
