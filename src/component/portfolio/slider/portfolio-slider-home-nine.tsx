...
// prop type
type IProps = {
  setWhiteCls: Dispatch<SetStateAction<boolean>>;
};
export default function PortfolioSliderHomeNine({ setWhiteCls }: IProps) {
  const [activeBg, setActiveBg] = useState<string | null>('tp-porfolio-10-bg-4');
    ...
    <div className="tp-porfolio-10-area tp-porfolio-10-height p-relative">
      <div className="tp-porfolio-10-bg-wrap">
        <div id="tp-porfolio-10-bg-box" className={activeBg ? activeBg : ""}>
          <BgImg imgSrc="/assets/img/home-10/porfolio/port-1.jpg" id="1" />
          <BgImg imgSrc="/assets/img/home-10/porfolio/port-2.jpg" id="2" />
          <BgImg imgSrc="/assets/img/home-10/porfolio/port-3.jpg" id="3" />
          <BgImg imgSrc="/assets/img/home-10/porfolio/port-4.jpg" id="4" />
          <BgImg imgSrc="/assets/img/home-10/porfolio/port-5.jpg" id="5" />
          <BgImg imgSrc="/assets/img/home-10/porfolio/port-6.jpg" id="6" />
          <BgImg imgSrc="/assets/img/home-10/porfolio/port-7.jpg" id="7" />
          <BgImg imgSrc="/assets/img/home-10/porfolio/port-5.jpg" id="8" />
        </div>
      </div>
