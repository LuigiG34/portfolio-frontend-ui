...
// slider images
const slider_images = [
  '/assets/img/inner-project/custom/port-1.jpg',
  '/assets/img/inner-project/custom/port-2.jpg',
  '/assets/img/inner-project/custom/port-3.jpg',
  '/assets/img/inner-project/custom/port-2.jpg',
];
  ...
  return (
    <>
          ...
          <div className="row">
            <div className="col-xl-8 col-lg-8">
              <div className="project-details-1-title-box">
                ...
                <Link className="project-details-custom-link" to="/portfolio-details-2">Visit Website</Link>
              </div>
            </div>
      ...
      <div className="pd-custom-full-img">
        <img data-speed=".8" src="/assets/img/inner-project/custom/custom-big-1.jpg" alt="full_img" />
      </div>
      {/* full image */}
      ...
      <div className="pd-visual-content-area pt-125 pb-125">
        <div className="container">
          ...
          <div className="pd-custom-full-img-2 mb-120 mt-120">
            <img style={{ width: "100%", height: "auto" }} data-speed=".8" src="/assets/img/inner-project/custom/custom-big-2.jpg" alt="full-image" />
          </div>
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-xl-6">
              <div className="pd-visual-right-content">
                <p className="tp_title_anim">The design needed to be as elegant and clean as possible. I chose a serif font that felt like one you’d see in a fashion newspaper, and plenty of negative space ensures that the pictures do not fight with each other for attention. I also used very muted colors to keep the focus on the saturated ones in Elena’s photos.</p>
                <p className="tp_title_anim">We build and activate brands through cultural insight, strategic vision, and the power of emotion across every element of its expression.</p>
              </div>
            </div>
          </div>
        </div>
