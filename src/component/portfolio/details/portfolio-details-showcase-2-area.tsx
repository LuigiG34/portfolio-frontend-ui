    ...
    <>
      ...
      <div className="showcase-details-2-area showcase-details-2-bg p-relative" style={{ backgroundImage: "url(/assets/img/inner-project/showcase/showcase-details-2-1.jpg)" }}>
        <div className="showcase-details-2-link">
          <Link className="project-details-custom-link" to="#">
            Visit Website
            <span>
              <UpArrow />
            </span>
          ...
          <div className="container container-1550">
            <div className="row">
              ...
              <div className="col-xxl-7 col-xl-10">
                <div className="showcase-details-2-content">
                  <p className='tp_title_anim'>Lorem ipsum dolor sit amet consectetur. Ultrices
      ...
      <div className="showcase-details-2-fullwidth-img">
        <img data-speed=".8" src="/assets/img/inner-project/showcase/showcase-details-2-10.jpg" alt="fullwidth_img" />
      </div>
      {/* full width image */}
          ...
          <div className="row">
            <div className="col-xl-6 col-lg-6">
              <div className="showcase-details-2-grid-img mb-30">
                <img className="img-left" src="/assets/img/inner-project/showcase/showcase-details-2-11.jpg" alt="details-img" />
              </div>
            </div>
            <div className="col-xl-6 col-lg-6">
              <div className="showcase-details-2-grid-img mb-30">
                <img className="img-right" src="/assets/img/inner-project/showcase/showcase-details-2-12.jpg" alt="details-img" />
              </div>
            </div>
          </div>
        </div>
