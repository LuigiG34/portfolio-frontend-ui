      ...
      <div className="tp-showcase-details-area">
        <div className="tp-showcase-details-bg d-flex align-items-center justify-content-center include-bg p-relative" style={{ backgroundImage: "url(/assets/img/inner-project/showcase/showcase-1.jpg)" }}>
          ...
          <div className="port-showcase-slider-social tp-hover-btn-wrapper">
            <Link className="tp-hover-btn-item tp-hover-btn" to="#">Fb</Link>
            <Link className="tp-hover-btn-item tp-hover-btn" to="#">In</Link>
            <Link className="tp-hover-btn-item tp-hover-btn" to="#">Be</Link>
          </div>
          ...
          <div className="row gx-80">
            <div className="col-xl-6 col-lg-6">
              <div className="showcase-details-thumb mb-80">
                <img data-speed=".8" src="/assets/img/inner-project/showcase/showcase-details-1.jpg" alt="details-thumb" />
              </div>
            </div>
            <div className="col-xl-6 col-lg-6">
              <div className="showcase-details-thumb mb-80">
                <img data-speed=".8" src="/assets/img/inner-project/showcase/showcase-details-2.jpg" alt="details-thumb" />
              </div>
            </div>
            <div className="col-xl-12">
              <div className="showcase-details-thumb mb-80">
                <img data-speed=".8" src="/assets/img/inner-project/showcase/showcase-details-3.jpg" alt="details-thumb" />
              </div>
            </div>
          </div>
        </div>
