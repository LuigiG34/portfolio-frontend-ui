...
const location_data = [
  {
    id: 1,
    img: "/assets/img/inner-contact/contact/info-1.jpg",
    country: "France",
    time: "12:00 pm GMT+2",
  ...
  {
    id: 2,
    img: "/assets/img/inner-contact/contact/info-2.jpg",
    country: "Germany",
    time: "11:00 pm GMT+2",
    location_title: "Base Create",
    address: "Base Creative, 43 Appleton <br /> Lane, 3287 Hamilton",
  ...
  {
    id: 3,
    img: "/assets/img/inner-contact/contact/info-3.jpg",
    country: "New Zealand",
    time: "10:00 pm GMT+2",
    location_title: "Base Create",
    address: "Base Creative, 43 Appleton <br /> Lane, 3287 Hamilton",
                ...
                <div className="col-xl-5">
                  <div className="cn-contact-right-wrap d-flex align-items-start justify-content-between">
                    ...
                    <div className="cn-contact-right-info text-start text-md-end">
                      <Link to="tel:(+91)76001726">{item.phone}</Link> <br />
                      <Link to="mailto:Hello@contact.com">{item.email}</Link>
                    </div>
                  </div>
                </div>
              </div>
