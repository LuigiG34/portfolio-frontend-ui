...
const location_data = [
  {
    id: 1,
    country: "Sydney",
    img_1: "/assets/img/inner-contact/contact/contact-1.jpg",
    img_2: "/assets/img/inner-contact/contact/contact-2.jpg",
  ...
  },
  {
    id: 2,
    country: "London",
    img_1: "/assets/img/inner-contact/contact/contact-3.jpg",
    img_2: "/assets/img/inner-contact/contact/contact-4.jpg",
    map: "https://www.google.com/maps/@23.822356,90.3671947,15z?entry=ttu",
  ...
  },
  {
    id: 3,
    country: "Join us",
    img_1: "/assets/img/inner-contact/contact/contact-5.jpg",
    img_2: "/assets/img/inner-contact/contact/contact-6.jpg",
    map: "https://www.google.com/maps/@23.822356,90.3671947,15z?entry=ttu",
    address:
            ...
            <div key={item.id} className="col-xl-4 col-lg-4 col-md-6 mb-30">
              <div className={`cn-contact-2-content ${item.id === 2 ? "mt-60" : ""} text-center`}>
                ...
                <div className="cn-contact-2-info-details">
                  <Link className="pb-15" to={item.map} target="_blank">
                    {item.address}
                  </Link>
                  <Link to={`mailto:${item.email}`}>{item.email}</Link>
                  {item.phone && <Link to={`tel:${item.phone}`}>{item.phone}</Link>}
