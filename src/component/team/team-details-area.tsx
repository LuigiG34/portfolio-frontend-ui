  ...
  return (
    <div className="tm-details-wrapper p-relative">
      <div className="tm-details-shape-1">
        <img src="/assets/img/home-01/team/team-details-shape-1.png" alt="shape" />
      </div>
      <div className="tm-details-shape-2">
        <img src="/assets/img/home-01/team/team-details-shape-2.png" alt="shape" />
      </div>
        ...
        <div className="row align-items-center align-items-xxl-end">
          ...
          <div className="col-xl-6 col-lg-6 col-md-5">
            <div className="tm-details-thumb">
              <img src="/assets/img/home-01/team/team-details-1.png" alt="team-details-img" />
            </div>
          </div>
        </div>
      </div>
