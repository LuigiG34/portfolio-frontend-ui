import { QuoteThree, Share, Tag } from "../../svg";
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="blog-details-thumb">
                      <img
                        className="mb-20"
                        src="/assets/img/inner-blog/blog-details-without-sidebar/blog-details-1.jpg"
                        alt="details-thumb"
                      />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="blog-details-thumb">
                      <img
                        className="mb-20"
                        src="/assets/img/inner-blog/blog-details-without-sidebar/blog-details-2.jpg"
                        alt="details-thumb"
                      />
                    </div>
                  </div>
                ...
                <div className="col-xl-8">
                  ...
                  <div className="blog-details-left-content tp_fade_bottom">
                    <p>
                      ...
                      design designers, they expect them to not only perform well, but
                ...
                <div className="row">
                  <div className="col-xl-12">
                    <div className="blog-details-thumb">
                      <img
                        className="w-100"
                        src="/assets/img/inner-blog/blog-details/blog-details-4.jpg"
                        alt="details-thumb"
                      />
                    </div>
                  </div>
